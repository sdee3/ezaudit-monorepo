...
const TermsConditions = () => (
  <Container maxW="container.xl">
    ...
    <Text mb={4}>Last updated: February 26, 2022</Text>
    <Text mb={4}>
    ...
    <ul>
      ...
      <li>
        <Text mb={4}>
          ...
          this Agreement) refers to EZ Audit.
        </Text>
      </li>
      <li>
        <Text mb={4}>
      ...
      <li>
        <Text mb={4}>
          <strong>Website</strong> refers to EZ Audit, accessible from{' '}
          <a
            href="https://ezaudit.me"
    ...
    <ul>
      <li>
        <Text mb={4}>Email address</Text>
      </li>
      <li>
        <Text mb={4}>Usage Data</Text>
      </li>
    </ul>
    <h3>Usage Data</h3>
    <Text mb={4}>
    ...
    <ul>
      <li>
        ...
        <Text mb={4}>Type: Session Cookies</Text>
        <Text mb={4}>Administered by: Us</Text>
        <Text mb={4}>
      ...
      <li>
        ...
        <Text mb={4}>Type: Persistent Cookies</Text>
        <Text mb={4}>Administered by: Us</Text>
        <Text mb={4}>
    ...
    <ul>
      <li>By email: hello@ezaudit.me</li>
    </ul>
  </Container>
)
